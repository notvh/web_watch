<div class="bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
    <div class="p-6 border-b border-gray-700 flex justify-between items-center">
        <h2 class="text-2xl font-bold text-yellow-500">Sản phẩm ({{ $products->total() }})</h2>
    ...
    <div class="p-6 bg-gray-900 flex flex-wrap gap-4">
        <input type="text" wire:model.live.debounce.500ms="search" placeholder="Tìm tên, SKU..." class="search-input">
                ...
                <tr class="hover:bg-gray-700 transition">
                    ...
                    <td>
                        <div class="action-btns">
                            ...
                            <button wire:click="delete({{ $p->id }})" wire:confirm="Xóa sản phẩm này?" class="text-red-400">
